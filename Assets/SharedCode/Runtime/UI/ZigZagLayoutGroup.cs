...
{
    [AddComponentMenu("Layout/ZigZag Layout Group", 152)]
    /// <summary>
    ...
    public class ZigZagLayoutGroup : LayoutGroup
    {
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            for (int i = 0; i < rectChildren.Count; i++)
            {
                ...
                // startOffset.x += ((i / cellCountX)/* % 2*/) * (cellSize[0] / 2);
                if ((i % cellCountX) == 0)
                {
                    if ((i / cellCountX) % 2 == 0) startOffset.x -= (cellSize[0] / 2);
                    else startOffset.x += (cellSize[0] / 2);
                }
